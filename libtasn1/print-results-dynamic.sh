...
print_header()
{
    echo "EXPERIMENT,RANDOM,DFS,COVERAGE"
}
...
print_results()
{
    ...
    cd $1
    print_header
    print_single_result   "cse-spa-no-searcher" "STATIC" $SUBBENCH
    print_single_result   "cse-pspa-no-searcher" "DYNAMIC" $SUBBENCH
    print_single_result   "cse-spa-split-searcher" "SEARCHER-STATIC" $SUBBENCH
    print_single_result   "cse-pspa-split-searcher" "SEARCHER-DYNAMIC" $SUBBENCH
